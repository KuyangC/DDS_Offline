...
class _ESP32IPDialogState extends State<ESP32IPDialog> {
  ...
  Future<void> _saveAndConnect() async {
    ...
    try {
      ...
      if (wsSuccess) {
        _showSuccessSnackBar('Host IP updated successfully!');
        if (mounted) {
          Navigator.of(context).pop(true); // Return success
        }
      } else {
        _showErrorSnackBar('Failed to update Host IP');
      }
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'Configure Host Communication connection',
                        style: TextStyle(
                          fontSize: 14,
