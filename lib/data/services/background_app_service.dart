// Dummy BackgroundAppService for offline mode (notifications disabled)
...
class BackgroundNotificationService {
  ...
  Future<void> stopAlarm() async {
    print('BackgroundNotificationService: stopAlarm called (offline mode - no-op)');
  }

  Future<void> cancelAllNotifications() async {}

  Future<void> stopAllAudioImmediately() async {
    print('BackgroundNotificationService: stopAllAudioImmediately called (offline mode - no-op)');
  }
}
